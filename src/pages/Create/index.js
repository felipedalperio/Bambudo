    ...
    return (
        <KeyboardAvoidingView
            ...
            <View style={styles.wrapper} keyboardShouldPersistTaps="always">
                ...
                <TextInput onChangeText={(text) => setUsername(text)} value={username} style={styles.input} placeholder='Username' placeholderTextColor={theme.primaryColorDark} type="text" />
